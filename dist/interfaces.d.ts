...
export declare type GetTransactionResponse = ConfirmedTransaction | UnconfirmedTransaction;
...
export declare type RescanTxArgs = RescanArg1 | RescanArg2 | RescanArg3;
...
export declare type Event = TransactionEvent | BlockEvent;
...
export declare type Destination = SweepAllDestination | AmountDestination;
...
declare type HealthStatus = 'Healthy' | 'Degraded' | 'Unhealthy';
